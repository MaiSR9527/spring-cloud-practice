package com.msr.better.provider.controller;
...
public class TestController {
    ...
    public String echoAppName(@PathVariable("app") String app) {
        // 这里已经使用了 loadBalancerClient 做了负载均衡 RestTemplate上的@LoadBalanced不能有，否则会出错
        ServiceInstance serviceInstance = loadBalancerClient.choose("dn-nacos-provider");
    ...
    public String rest(@PathVariable String str) {
        ...
        return restTemplate.getForObject("http://dn-nacos-provider/echo/" + str, String.class);
    }

    @GetMapping("/index")
    public String index(HttpServletRequest request) {
		/*for (int i=0; i<2; i++) {
			String result = restTemplate.getForObject("http://dn-nacos-provider/", String.class);
        ...
        return restTemplate.getForObject("http://dn-nacos-provider/", String.class);
    }
    ...
    public String test() {
        ...
        return restTemplate.getForObject("http://dn-nacos-provider/test", String.class);
    }
...
//	}
    ...
    @GetMapping("/sleep")
    public String sleep() {
        return restTemplate.getForObject("http://dn-nacos-provider/sleep", String.class);
    }

    @GetMapping("/notFound-feign")
    public String notFound() {
        return echoServiceApi.notFound();
    }

    @GetMapping("/divide-feign")
    public String divide(@RequestParam Integer a, @RequestParam Integer b) {
        return echoServiceApi.divide(a, b);
    }

    @GetMapping("/divide-feign2")
    public String divide(@RequestParam Integer a) {
        return echoServiceApi.divide(a);
    }

    @GetMapping("/echo-feign/{str}")
    public String feign(@PathVariable String str) {
        return echoServiceApi.echo(str);
    }
